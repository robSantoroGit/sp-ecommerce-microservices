...
print_step "Step 12: Test Errore 404 - Prodotto Inesistente..."
...
print_step "Step 13: Test Ricerca Senza Risultati..."
...
print_step "Step 14: Test Rate Limiting (6 richieste rapide)..."
for i in {1..6}; do
...
print_step "Step 15: Gateway Health Check..."
...
echo "  ✓ Cleanup finale"
echo ""
print_success "Database pulito - Solo SUPERADMIN presente"
echo ""